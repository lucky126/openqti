 ...
 *         &lt;element ref="{http://www.open.com.cn/schemas/exam/openqti_v1}proficiency" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.open.com.cn/schemas/exam/openqti_v1}ext_language" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "language", namespace = "http://www.open.com.cn/schemas/exam/openqti_v1")
public class Language {
    ...
    @XmlElement(namespace = "http://www.open.com.cn/schemas/exam/openqti_v1")
    protected List<Proficiency> proficiency;
    @XmlElement(name = "ext_language", namespace = "http://www.open.com.cn/schemas/exam/openqti_v1")
    ...
    public List<Proficiency> getProficiency() {
        if (proficiency == null) {
            proficiency = new ArrayList<Proficiency>();
        }
